...
class registration_controller extends Controller
{
    ...
    {
        $this->middleware('CheckFirstTimeRegister')->only('first_time');
        $this->middleware('CheckAdmin')->only('register_admin');
        $this->middleware('CheckCategory')->only('register_category_asset');
        $this->middleware('CheckAsset')->only('register_asset_new');
        $this->middleware('CheckItem')->only('register_asset_item');
    }
    ...
    public function first_time(Request $request)
    {
        ...
        return redirect('/')->with('statement','Pendaftaran telah berjaya dilakukan');
